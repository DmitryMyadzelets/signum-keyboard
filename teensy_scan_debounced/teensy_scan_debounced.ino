...
uint32_t keys_new[keys_uint32]; // Keys which have just changed its state
uint8_t keys_states[KEYS]; // Keys' state history for debouncing
...
void loop() {
  ...
  // Get keys just pressed or released
